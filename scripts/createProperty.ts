  ...
  const properties = [
    {
      ...
      price: 500000,
      category: "Corporate",
      images: ["https://via.placeholder.com/400"], // Stored as JSON array
      latitude: 40.7128,
      longitude: -74.006,
      type: "Corporate",
      manager: "John Doe, +1 234 567 890",
      status: 1,
    },
    {
      ...
      longitude: -118.2437,
      type: "Retail",
      manager: "Jane Smith, +1 987 654 321",
      status: 1,
    },
    {
      ...
      longitude: -0.1278,
      type: "Residential",
      manager: "Alice Johnson, +44 123 456 789",
      status: 1,
    },
  ];
